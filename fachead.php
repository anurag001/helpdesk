...
<html lang="eng">
	...
	<body>
		...
		<div id="add_student">
			...
			<div style="font-family:robob;font-size:1.7em;margin-bottom:10px;float:right;z-index:5;text-shadow:0px 0px 10px #fff;">Facility Head Registration Here<br>Complete Administrator Access</div>
